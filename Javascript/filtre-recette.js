...
export function applyMainFilter() {
    ...
    // Après avoir filtré, on affiche les recettes et met à jour les options du select
    if (filteredRecipes.length === 0) {
        displayNoResultsMessage(filterText);  // Afficher un message si aucune recette n'est trouvée
    } else {
